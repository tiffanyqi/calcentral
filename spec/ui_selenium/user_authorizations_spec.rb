    ...
    describe 'View-as' do
      ...
      context 'when an admin has viewed-as' do
        ...
        it 'allows the admin to see recently viewed users' do
          @toolbox_page.wait_until(timeout) { @toolbox_page.recent_user_view_as_button == '61889' }
          @toolbox_page.wait_until(timeout) { @toolbox_page.recent_user_sid == '11667051' }
          @toolbox_page.wait_until(timeout) { @toolbox_page.recent_user_name == 'Oski' }
        end
        it 'allows the admin to save recently viewed users' do
          ...
          @toolbox_page.wait_until(timeout) { @toolbox_page.saved_user_view_as_button == '61889' }
          @toolbox_page.wait_until(timeout) { @toolbox_page.saved_user_sid == '11667051' }
          @toolbox_page.wait_until(timeout) { @toolbox_page.saved_user_name == 'Oski' }
        end
      end
