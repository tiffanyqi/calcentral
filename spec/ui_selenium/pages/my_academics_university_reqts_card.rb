module CalCentralPages
  ...
  class MyAcademicsUniversityReqtsCard < MyAcademicsPage
    ...
    link(:writing_reqt_unmet, :xpath => '//span[text()="UC Entry Level Writing"]/following-sibling::span/a[contains(text(),"Incomplete")]')
    span(:history_reqt_met, :xpath => '//span[text()="American History"]/following-sibling::span[text()="Completed"]')
    link(:history_reqt_unmet, :xpath => '//span[text()="American History"]/following-sibling::span/a[contains(text(),"Incomplete")]')
    span(:institutions_reqt_met, :xpath => '//span[text()="American Institutions"]/following-sibling::span[text()="Completed"]')
    link(:institutions_reqt_unmet, :xpath => '//span[text()="American Institutions"]/following-sibling::span/a[contains(text(),"Incomplete")]')
    span(:cultures_reqt_met, :xpath => '//span[text()="American Cultures"]/following-sibling::span[text()="Completed"]')
    link(:cultures_reqt_unmet, :xpath => '//span[text()="American Cultures"]/following-sibling::span/a[contains(text(),"Incomplete")]')
