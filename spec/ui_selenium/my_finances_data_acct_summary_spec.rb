describe 'My Finances Billing Summary', :testui => true do
  ...
  if ENV["UI_TEST"] && Settings.ui_selenium.layer != 'production'
    ...
    begin
      ...
      test_users = UserUtils.load_test_users.select { |user| user['finances'] }
      testable_users = []
        ...
        begin
          ...
          if fin_api_page.has_cars_data?
            ...
            if status_api_page.is_student? || status_api_page.is_ex_student?
              ...
              my_finances_page.status_popover_heading_element.when_visible WebDriverUtils.page_event_timeout
