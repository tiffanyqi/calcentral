  ...
  return {
    ...
    link: function(scope, elem, attrs) {
      scope.$watch(attrs.ccYoutubeDirective, function(value) {
        ...
        var templates = {
          image: '<button id="cc-youtube-image-placeholder" class="cc-youtube-image-placeholder" tabindex="0"><span class="cc-visuallyhidden">Play video' + title + '</span><img data-ng-src="' + imageUrl + '" alt=""><div class="cc-youtube-thumbnail-button"></div></button>',
